class Vehicle {
    constructor(x, y) {
        ...
        this.maxSpeed = 160;//random(150, 200);
        this.maxForce = 6;//random(5, 8);

        this.seekWeight = random(1);
    ...
    draw() {
        ...
        fill(map(this.seekWeight, 0, 1, 50, 200),
            map(this.fleeWeight, 0, 1, 50, 200),
            map(this.alignWeight, 0, 1, 50, 200));
